...
class FOURIERFunction(torch.autograd.Function):
    ...
    def forward(ctx, head_q, head_k, paramR):
        ...
        output = fourier_R_cuda.forward(head_q, head_k, paramR)
...
class FourierAttn1(nn.Module):
    def __init__(self, n_head, d_model, d_head):
        ...
        self.paramR = torch.randn( (d_head), device = cuda_device, dtype=torch.float, requires_grad=True)
...
print('\nmodel1.paramR.grad:', model1.paramR.grad[1:4] )
